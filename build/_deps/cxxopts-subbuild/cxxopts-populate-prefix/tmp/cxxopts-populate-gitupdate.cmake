...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.2.1"
  WORKING_DIRECTORY "/home/wjy/MyLapGym/build/_deps/cxxopts-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/wjy/MyLapGym/build/_deps/cxxopts-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/wjy/MyLapGym/build/_deps/cxxopts-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
