# CMake package configuration file for SofaValidation
...
if(NOT "${CMAKE_PROJECT_NAME}" STREQUAL "Sofa" OR NOT "${PROJECT_SOURCE_DIR}" MATCHES "${CMAKE_SOURCE_DIR}/.*")
    ...
    get_property(SofaValidation_SENT_DEPRECATION_MESSAGE GLOBAL PROPERTY PROPERTY_SofaValidation_SENT_DEPRECATION_MESSAGE SET)
    if(NOT SofaValidation_SENT_DEPRECATION_MESSAGE)
        message(WARNING "SofaValidation module is deprecated. It will be removed at v23.06. For CompareState and CompareTopology, use Sofa.Component.Playback instead.")
    endif()
    set_property(GLOBAL PROPERTY PROPERTY_SofaValidation_SENT_DEPRECATION_MESSAGE TRUE)
endif()
