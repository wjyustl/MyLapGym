# CMake package configuration file for SofaHaptics
...
if(NOT "${CMAKE_PROJECT_NAME}" STREQUAL "Sofa" OR NOT "${PROJECT_SOURCE_DIR}" MATCHES "${CMAKE_SOURCE_DIR}/.*")
    ...
    get_property(SofaHaptics_SENT_DEPRECATION_MESSAGE GLOBAL PROPERTY PROPERTY_SofaHaptics_SENT_DEPRECATION_MESSAGE SET)
    if(NOT SofaHaptics_SENT_DEPRECATION_MESSAGE)
        message(WARNING "SofaHaptics module is deprecated. It will be removed at v23.06. Use Sofa.Component.Haptics instead.")
    endif()
    set_property(GLOBAL PROPERTY PROPERTY_SofaHaptics_SENT_DEPRECATION_MESSAGE TRUE)
endif()
