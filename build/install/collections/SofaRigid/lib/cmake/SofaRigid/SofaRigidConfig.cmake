# CMake package configuration file for SofaRigid
...
if(NOT "${CMAKE_PROJECT_NAME}" STREQUAL "Sofa" OR NOT "${PROJECT_SOURCE_DIR}" MATCHES "${CMAKE_SOURCE_DIR}/.*")
    ...
    if(NOT SofaRigid_SENT_DEPRECATION_MESSAGE)
        message(WARNING "SofaRigid module is deprecated. It will be removed at v23.06. Use Sofa.Component.Mapping and Sofa.Component.SolidMechanics.Spring instead.")
    endif()
