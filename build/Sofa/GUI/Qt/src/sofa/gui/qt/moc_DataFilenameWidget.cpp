...
#include <memory>
#include "../../../../../../../../src/Sofa/GUI/Qt/src/sofa/gui/qt/DataFilenameWidget.h"
...
void sofa::gui::qt::DataFileNameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DataFileNameWidget *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject sofa::gui::qt::DataFileNameWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<TDataWidget<std::string>::staticMetaObject>(),
    qt_meta_stringdata_sofa__gui__qt__DataFileNameWidget.data,
    qt_meta_data_sofa__gui__qt__DataFileNameWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
