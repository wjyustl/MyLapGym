...
#include <memory>
#include "../../../../../../../../src/Sofa/GUI/Qt/src/sofa/gui/qt/QTransformationWidget.h"
...
void sofa::gui::qt::QTransformationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QTransformationWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (QTransformationWidget::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject sofa::gui::qt::QTransformationWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QGroupBox::staticMetaObject>(),
    qt_meta_stringdata_sofa__gui__qt__QTransformationWidget.data,
    qt_meta_data_sofa__gui__qt__QTransformationWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
