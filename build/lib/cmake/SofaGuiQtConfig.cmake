# CMake package configuration file for SofaGuiQt
...
if(NOT "${CMAKE_PROJECT_NAME}" STREQUAL "Sofa" OR NOT "${PROJECT_SOURCE_DIR}" MATCHES "${CMAKE_SOURCE_DIR}/.*")
    ...
    get_property(SofaGuiQt_SENT_DEPRECATION_MESSAGE GLOBAL PROPERTY PROPERTY_SofaGuiQt_SENT_DEPRECATION_MESSAGE SET)
    if(NOT SofaGuiQt_SENT_DEPRECATION_MESSAGE)
        message(WARNING "SofaGuiQt module is deprecated. It will be removed at v23.06. Use Sofa.GUI.Qt instead.")
    endif()
    set_property(GLOBAL PROPERTY PROPERTY_SofaGuiQt_SENT_DEPRECATION_MESSAGE TRUE)
endif()
