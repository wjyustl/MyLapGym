# CMake package configuration file for SofaBaseMechanics
...
if(NOT "${CMAKE_PROJECT_NAME}" STREQUAL "Sofa" OR NOT "${PROJECT_SOURCE_DIR}" MATCHES "${CMAKE_SOURCE_DIR}/.*")
    ...
    if(NOT SofaBaseMechanics_SENT_DEPRECATION_MESSAGE)
        message(WARNING "SofaBaseMechanics module is deprecated. It will be removed at v23.06. Use Sofa.Component.Mass, Sofa.Component.Mapping.Linear and Sofa.Component.StateContainer instead.")
    endif()
