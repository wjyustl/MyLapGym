# CMake package configuration file for Sofa.SimulationCore
...
if(NOT "${CMAKE_PROJECT_NAME}" STREQUAL "Sofa" OR NOT "${PROJECT_SOURCE_DIR}" MATCHES "${CMAKE_SOURCE_DIR}/.*")
    ...
    if(NOT Sofa.SimulationCore_SENT_DEPRECATION_MESSAGE)
        message(WARNING "Sofa.SimulationCore module is deprecated. It will be removed at v23.06. Use Sofa.Simulation.Core instead.")
    endif()
...
if(NOT TARGET Sofa.SimulationCore)
    include("${CMAKE_CURRENT_LIST_DIR}/Sofa.SimulationCoreTargets.cmake")
endif()
check_required_components(Sofa.SimulationCore)
