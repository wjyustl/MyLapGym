# CMake package configuration file for SofaEigen2Solver
...
if(NOT "${CMAKE_PROJECT_NAME}" STREQUAL "Sofa" OR NOT "${PROJECT_SOURCE_DIR}" MATCHES "${CMAKE_SOURCE_DIR}/.*")
    ...
    if(NOT SofaEigen2Solver_SENT_DEPRECATION_MESSAGE)
        message(WARNING "SofaEigen2Solver module is deprecated. It will be removed at v23.06. Use Sofa.LinearAlgebra (Eigen classes) and Sofa.Component.LinearSolver.Direct (SVDLinearSolver) instead.")
    endif()
...
find_package(Sofa.LinearAlgebra QUIET REQUIRED)
