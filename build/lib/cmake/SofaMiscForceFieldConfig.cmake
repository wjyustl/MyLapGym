# CMake package configuration file for SofaMiscForceField
...
if(NOT "${CMAKE_PROJECT_NAME}" STREQUAL "Sofa" OR NOT "${PROJECT_SOURCE_DIR}" MATCHES "${CMAKE_SOURCE_DIR}/.*")
    ...
    if(NOT SofaMiscForceField_SENT_DEPRECATION_MESSAGE)
        message(WARNING "SofaMiscForceField module is deprecated. It will be removed at v23.06. Use Sofa.Component.Mass and Sofa.Component.SolidMechanics.FEM.Elastic instead.")
    endif()
